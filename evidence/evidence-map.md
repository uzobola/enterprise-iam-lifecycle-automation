...
| EVID-03A | `screenshots/03a-midpoint-users-before-hr-reconciliation.png` | midPoint Users page before HR reconciliation | No governed workforce identities existed before source reconciliation | Baseline state |
| EVID-03B | `screenshots/03b-midpoint-users-after-provisioning.png` | midPoint Users page showing users 1001–1008 with linked accounts | HR records became governed identities and were linked to downstream accounts | Automated identity creation and account linkage |
...
| EVID-07B | `screenshots/07b-leaver-midpoint-simplifyhr-shadow-terminated.png` | midPoint view of Oliver Bennett’s SimplifyHR source account showing `status = Terminated` | midPoint consumed the terminated lifecycle status from the authoritative HR source | Source lifecycle validation |
| EVID-08 | `screenshots/08-leaver-midpoint-disabled.png` | midPoint Users page showing Oliver Bennett with disabled status and reduced account linkage | midPoint disabled the governed identity after HR-driven reconciliation | Centralized lifecycle governance |
