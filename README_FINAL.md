...
Designed and implemented an enterprise IAM lifecycle automation project using midPoint and OpenLDAP, integrating an HR source for automated identity creation, attribute mapping, identity correlation, reconciliation, LDAP provisioning, leaver handling, non-human identity discovery, and audit evidence validation mapped to access governance controls.
